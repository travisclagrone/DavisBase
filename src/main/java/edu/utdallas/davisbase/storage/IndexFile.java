...
public class IndexFile implements Closeable {
	...
	public void addRowIdInRecord(long pageOffset, short recordOffset, short minRecordOffset, int rowId)
			throws IOException {
	...
	public void addText(@Nullable String indexValue, int rowId) throws IOException {
		...
		/*
		 * if noOfRecordsInRootPage is 0 then add record in rootPage else if it matches
		 * with root page record value, insert just the rowId else determine to which
		 * child it should check with
		 */
